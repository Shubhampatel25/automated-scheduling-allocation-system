...
Route::get('/courses', [DashboardController::class, 'hodCourses'])->name('hod.courses');

Route::get('/assignments', [DashboardController::class, 'hodAssignments'])->name('hod.assignments');
