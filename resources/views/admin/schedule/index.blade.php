...
{{-- modal styles are in partials/timetable-modal --}}
.summary-cards {
    display: grid;
    ...
    <div class="card-body">
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn-view-tt"
                                onclick="openTimetableModal({{ $tt->id }}, '{{ addslashes($tt->department->name ?? 'N/A') }}', '{{ $tt->term }} {{ $tt->year }}', {{ $tt->semester }})">
                            &#128065; View
                        </button>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="11" style="text-align:center;padding:32px;color:#9ca3af">
