        ...
        <div class="card-header">
            ...
            <div class="table-toolbar">
                <div class="rows-label">
                    Filter
                    <select onchange="window.location.href='{{ route('admin.fee-payments.index') }}?status='+this.value+'&tab=records'">
        ...
        <div class="card-body">
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="10" style="text-align:center;padding:24px;color:#9ca3af">No fee payment records found.</td></tr>
                    @endforelse
                </tbody>
            </table>
            </div>{{-- /.table-scroll --}}
