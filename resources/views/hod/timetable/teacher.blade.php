...
<div class="breadcrumb no-print">
    ...
    <a href="{{ route('hod.faculty-members') }}">Faculty Members</a> /
...
<div class="meta-bar">
    <div class="meta-item"><div class="lbl">Teacher</div><div class="val">{{ $teacher->name }}</div></div>
    ...
    <div class="meta-item"><div class="lbl">Weekly Classes</div><div class="val">{{ $slots->count() }}</div></div>
    <div class="meta-item">
...
<div style="background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.07);padding:20px;overflow-x:auto;">
    @php
        $days    = ['Monday','Tuesday','Wednesday','Thursday','Friday'];
        $periods = $slots->map(fn($s) => ['start'=>substr($s->start_time,0,5),'end'=>substr($s->end_time,0,5)])
