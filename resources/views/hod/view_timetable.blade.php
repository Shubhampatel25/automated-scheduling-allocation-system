...
.slot-cell { background:#eef2ff; border-radius:6px; padding:6px 8px; }
.slot-course { font-weight:700; color:#3730a3; font-size:.82rem; margin-bottom:2px; }
.slot-room { font-size:.76rem; color:#6366f1; }
.slot-teacher { font-size:.76rem; color:#64748b; }
